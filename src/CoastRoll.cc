...
public:
    ...
    OpenGLPaintableWidget (Mesh * terr, Mesh * spine, Mesh * canyon, Mesh * warp,QWidget *parent) : QGLWidget(parent)
    {
        terrain = terr;
        terrain2 = spine;
        terrain3 = canyon;
    ...
    void initializeGL ()
    {
        ...
        terraintexture = new TextureMap ("./resources/terrain.png");
        startexture = new TextureMap ("./resources/starscape.png");
        meteortexture = new TextureMap ("./resources/meteor.png");
...

{
    ...
    Mesh * m1 = new Mesh ("./resources/terrain");
    Mesh * m2 = new Mesh ("./resources/spiny");
    Mesh * m3 = new Mesh ("./resources/spiny2");
    Mesh * m4 = new Mesh ("./resources/spiny3");

    OpenGLPaintableWidget w (m1, m2, m3, m4, NULL);
    w.show();
